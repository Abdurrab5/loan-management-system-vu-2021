...
<body>
	...
	<div class="container">
		<h2>Loan Management System </h2>
		 <a href="../logout.php" style="color:white;float:right" ><?php echo $_SESSION['officer'] ?><i class="  fa fa-power-off"></i></a>
		<div class="btn-group btn-group-sm"> 
		<a href="officerpanel.php" class="btn btn-primary" role="button">Dashboard</a>
