...
<body>
  ...
  <div class="container">
    ...
    $query="SELECT * FROM officer WHERE name='$aid' and password='$password' ";
    $result= mysqli_query($link, $query);
    if(mysqli_num_rows($result)){
        $row= mysqli_fetch_array($result);
        $_SESSION['officer']=$row['name']; 
        alert("You have been logged-in successfuly.");
        //redirecting
        redirect_to("officerpanel.php");
    }else{
...
?>
	<div>
		<h3 class="container"> Officer Login</h3>
	</div>
